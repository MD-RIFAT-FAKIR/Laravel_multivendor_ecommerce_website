                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{route('user.profile.logout')}}"><i class="fi fi-rs-sign-out mr-10"></i>Sign out</a>
                                            </li>
                                        </ul>
                                    </div>
                                    @else
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    ...
                                    @php
                                        $subcategories = App\Models\Subcategor::where('category_id',$category->id)->orderBy('subcategory_name','ASC')->get();
                                    @endphp
