					    ...
					    <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							...
							<div class="form-group mb-3">
								...
								<input type="text" name="product_tags" class="form-control visually-hidden __web-inspector-hide-shortcut__" data-role="tagsinput" value="new product,top product">
							</div>
							<div class="form-group mb-3">
								<label for="inputProductTitle" class="form-label">Product Size</label>
								<input type="text" name="product_size" class="form-control visually-hidden __web-inspector-hide-shortcut__" data-role="tagsinput" value="Small,Midium,Large">
							</div>
							<div class="form-group mb-3">
								<label for="inputProductTitle" class="form-label">Product Color</label>
								<input type="text" name="product_color" class="form-control visually-hidden __web-inspector-hide-shortcut__" data-role="tagsinput" value="Red,Blue,Black">
							</div>
							<div class="form-group mb-3">
							...
							<div class="mb-3">
                                ...
                                <textarea id="mytextarea" name="long_descp">Long, Description!</textarea>
							</div>
							<div class="form-group mb-3">
