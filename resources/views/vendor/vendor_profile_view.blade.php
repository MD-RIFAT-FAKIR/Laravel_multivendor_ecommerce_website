            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{(!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo) : url('upload/no_image.jpg')}}" style="width: 100px; height: 100px;"alt="Vendoe" class="rounded-circle p-1 bg-primary" width="110">
                        <div class="mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <select class="form-select" name="vendor_join" aria-label="Default select example">
                                ...
                                <option value="2026" {{$vendorData->vendor_join == 2025 ? 'selected' : ''}} >2026</option>
							</select>
                        </div>
                    </div>
                    <div class="row mb-3">
